...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="card">
                <div id="header_card" class="card-header">{{ __('Edit Profile') }}</div>
                ...
                <div class="bg_all card-body">
                    <form method="POST" action="{{ URL::to('/editProfile/submit') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="date_of_birth" value="{{ Auth::user()->date_of_birth }}" type="date" class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" value="{{ old('date_of_birth') }}" required autocomplete="date_of_birth" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" value="{{ Auth::user()->address }}" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="address" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile_no" value="{{ Auth::user()->mobile_no }}" type="text" class="form-control @error('mobile_no') is-invalid @enderror" name="mobile_no" value="{{ old('mobile_no') }}" required autocomplete="mobile_no" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="personal_bkash_no" value="{{ Auth::user()->personal_bkash_no }}" type="text" class="form-control @error('personal_bkash_no') is-invalid @enderror" name="personal_bkash_no" value="{{ old('personal_bkash_no') }}" required autocomplete="personal_bkash_no" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="paypal_account_no" value="{{ Auth::user()->paypal_account_no }}" type="text" class="form-control" name="paypal_account_no" value="{{ old('paypal_account_no') }}" autocomplete="paypal_account_no" autofocus>
                            </div>
                        </div>
